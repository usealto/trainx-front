...
// @ts-ignore
import { PutCompanyDtoApi } from '../model/putCompanyDto';
...
export interface PutCompanyRequestParams {
    id: string;
    putCompanyDtoApi: PutCompanyDtoApi;
    /** The ID of the company that the user sending the request is related to.  This field is required when using the API Key.  It will be included in the JSON Web Token (JWT) when using Auth0 authentication. */
    companyId?: string;
    /** The ID of the user sending the request.  This field is required when using the API Key.  It will be included in the JSON Web Token (JWT) when using Auth0 authentication.  Used to set the &#x60;createdBy&#x60; property on creation of entities. */
    userId?: string;
...
export class CompaniesApiService {
    ...
    /**
     * Put an existing company by ID
     * This method handles PUT requests to the \&#39;/companies/:id\&#39; route where :id is a company ID, it updates a single company with the ID :id and return it. If the company with ID does not exists we return an error.
     * @param requestParameters
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    ...
    public putCompany(requestParameters: PutCompanyRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        const putCompanyDtoApi = requestParameters.putCompanyDtoApi;
        if (putCompanyDtoApi === null || putCompanyDtoApi === undefined) {
            throw new Error('Required parameter putCompanyDtoApi was null or undefined when calling putCompany.');
        }
        const companyId = requestParameters.companyId;
        const userId = requestParameters.userId;
