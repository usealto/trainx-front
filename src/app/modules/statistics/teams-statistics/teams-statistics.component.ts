...
import { Subscription, combineLatest, concat, of, debounceTime, startWith, switchMap, tap } from 'rxjs';
...
import { Score, EScoreDuration } from '../../../models/score.model';
...
@Component({
  selector: 'alto-teams-statistics',
